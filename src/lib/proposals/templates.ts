...
export const TEMPLATES: Record<TemplateId, TemplateDefinition> = {
  ...
  inspection_report: {
    ...
    fields: [
      ...
      { key: "ir_initial_cost", label: "Initial Service Cost ($)", type: "text", placeholder: "e.g., 2500", section: "Pricing" },
      { key: "ir_initial_includes", label: "Initial Service Includes", type: "bullet-list", placeholder: "e.g., Trapping program setup", section: "Pricing" },
      { key: "ir_recurring_cost", label: "Per Visit / Recurring Cost ($)", type: "text", placeholder: "e.g., 175", section: "Pricing" },
      { key: "ir_recurring_includes", label: "Per Visit Includes", type: "bullet-list", placeholder: "e.g., Scheduled service visit", section: "Pricing" },
      { key: "ir_monthly_total", label: "Monthly Total ($)", type: "text", placeholder: "e.g., 350", section: "Pricing" },
      { key: "ir_monthly_includes", label: "Monthly Total Includes", type: "bullet-list", placeholder: "e.g., Two visits per month", section: "Pricing" },
      { key: "ir_onetime_cost", label: "One-Time Service Cost ($)", type: "text", placeholder: "e.g., 450", section: "Pricing" },
      { key: "ir_onetime_includes", label: "One-Time Service Includes", type: "bullet-list", placeholder: "e.g., One-time exclusion work", section: "Pricing" },
