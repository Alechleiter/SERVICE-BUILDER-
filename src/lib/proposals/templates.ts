...
export const TEMPLATES: Record<TemplateId, TemplateDefinition> = {
  ...
  inspection_report: {
    ...
    fields: [
      ...
      // ── Covered Pests (pests covered under the service agreement) ──
      { key: "covered_pests", label: "Covered Pests", type: "multi-select", options: [
        "Ants (excluding carpenter ants and fire ants)",
        "German Cockroaches",
        "American Cockroaches",
        "Rodents (rats and mice)",
        ...
        "Wasps",
        "Bees",
      ], section: "Covered Pests" },
      // ── Service Options (scope + pricing per option) ──
      { key: "ir_option_count", label: "Number of Service Options", type: "select", options: ["1", "2", "3"], section: "Service Options" },
      // ── Option A (always visible) — Scope ──
      { key: "ir_option_a_name", label: "Option A — Name", type: "text", placeholder: "e.g., Monthly General Pest", section: "Service Options" },
      { key: "ir_service_frequency", label: "Option A — Service Frequency", type: "text", placeholder: "e.g., 2x per month", section: "Service Options" },
      { key: "ir_service_areas", label: "Option A — Service Areas", type: "text", placeholder: "e.g., Exterior and interior", section: "Service Options" },
      { key: "ir_phase1_title", label: "Option A — Phase 1 Title", type: "text", placeholder: "Initial Service", section: "Service Options" },
      { key: "ir_phase1_duration", label: "Option A — Phase 1 Duration", type: "text", placeholder: "e.g., Month 1", section: "Service Options" },
      { key: "ir_phase1_items", label: "Option A — Phase 1 Work Items", type: "bullet-list", placeholder: "e.g., Intensive trapping program", section: "Service Options" },
      { key: "ir_phase2_title", label: "Option A — Phase 2 Title", type: "text", placeholder: "Ongoing Service", section: "Service Options" },
      { key: "ir_phase2_duration", label: "Option A — Phase 2 Duration", type: "text", placeholder: "e.g., Monthly", section: "Service Options" },
      { key: "ir_phase2_items", label: "Option A — Phase 2 Work Items", type: "bullet-list", placeholder: "e.g., Check and service all traps", section: "Service Options" },
      // ── Option A — Pricing ──
      { key: "ir_initial_cost", label: "Option A — Initial Service Cost ($)", type: "text", placeholder: "e.g., 2500", section: "Service Options" },
      { key: "ir_initial_includes", label: "Option A — Initial Includes", type: "bullet-list", placeholder: "e.g., Trapping program setup", section: "Service Options" },
      { key: "ir_recurring_cost", label: "Option A — Per Visit Cost ($)", type: "text", placeholder: "e.g., 175", section: "Service Options" },
      { key: "ir_recurring_includes", label: "Option A — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Scheduled service visit", section: "Service Options" },
      { key: "ir_monthly_total", label: "Option A — Monthly Total ($)", type: "text", placeholder: "e.g., 350", section: "Service Options" },
      { key: "ir_monthly_includes", label: "Option A — Monthly Includes", type: "bullet-list", placeholder: "e.g., Two visits per month", section: "Service Options" },
      { key: "ir_onetime_cost", label: "Option A — One-Time Cost ($)", type: "text", placeholder: "e.g., 450", section: "Service Options" },
      { key: "ir_onetime_includes", label: "Option A — One-Time Includes", type: "bullet-list", placeholder: "e.g., One-time exclusion work", section: "Service Options" },
      // ── Option B (visible when option_count >= 2) — Scope ──
      { key: "ir_b_name", label: "Option B — Name", type: "text", placeholder: "e.g., Quarterly Exterior Only", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_frequency", label: "Option B — Service Frequency", type: "text", placeholder: "e.g., 1x per quarter", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_areas", label: "Option B — Service Areas", type: "text", placeholder: "e.g., Exterior only", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase1_title", label: "Option B — Phase 1 Title", type: "text", placeholder: "Initial Service", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase1_duration", label: "Option B — Phase 1 Duration", type: "text", placeholder: "e.g., First visit", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase1_items", label: "Option B — Phase 1 Work Items", type: "bullet-list", placeholder: "e.g., Perimeter treatment", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase2_title", label: "Option B — Phase 2 Title", type: "text", placeholder: "Ongoing Service", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase2_duration", label: "Option B — Phase 2 Duration", type: "text", placeholder: "e.g., Quarterly", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_phase2_items", label: "Option B — Phase 2 Work Items", type: "bullet-list", placeholder: "e.g., Quarterly perimeter spray", section: "Service Options", showIf: "ir_option_count:2,3" },
      // ── Option B — Pricing ──
      { key: "ir_b_initial_cost", label: "Option B — Initial Cost ($)", type: "text", placeholder: "e.g., 1200", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_initial_includes", label: "Option B — Initial Includes", type: "bullet-list", placeholder: "e.g., Perimeter treatment", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_recurring_cost", label: "Option B — Per Visit Cost ($)", type: "text", placeholder: "e.g., 125", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_recurring_includes", label: "Option B — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Exterior perimeter spray", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_monthly_total", label: "Option B — Monthly Total ($)", type: "text", placeholder: "e.g., 125", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_monthly_includes", label: "Option B — Monthly Includes", type: "bullet-list", placeholder: "e.g., One visit per quarter", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_onetime_cost", label: "Option B — One-Time Cost ($)", type: "text", placeholder: "e.g., 300", section: "Service Options", showIf: "ir_option_count:2,3" },
      { key: "ir_b_onetime_includes", label: "Option B — One-Time Includes", type: "bullet-list", placeholder: "e.g., One-time seal-up", section: "Service Options", showIf: "ir_option_count:2,3" },
      // ── Option C (visible when option_count == 3) — Scope ──
      { key: "ir_c_name", label: "Option C — Name", type: "text", placeholder: "e.g., Premium Full-Service", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_frequency", label: "Option C — Service Frequency", type: "text", placeholder: "e.g., Weekly", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_areas", label: "Option C — Service Areas", type: "text", placeholder: "e.g., Full interior + exterior", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase1_title", label: "Option C — Phase 1 Title", type: "text", placeholder: "Initial Service", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase1_duration", label: "Option C — Phase 1 Duration", type: "text", placeholder: "e.g., First 2 weeks", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase1_items", label: "Option C — Phase 1 Work Items", type: "bullet-list", placeholder: "e.g., Full interior + exterior treatment", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase2_title", label: "Option C — Phase 2 Title", type: "text", placeholder: "Ongoing Service", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase2_duration", label: "Option C — Phase 2 Duration", type: "text", placeholder: "e.g., Weekly", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_phase2_items", label: "Option C — Phase 2 Work Items", type: "bullet-list", placeholder: "e.g., Full service visit", section: "Service Options", showIf: "ir_option_count:3" },
      // ── Option C — Pricing ──
      { key: "ir_c_initial_cost", label: "Option C — Initial Cost ($)", type: "text", placeholder: "e.g., 3500", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_initial_includes", label: "Option C — Initial Includes", type: "bullet-list", placeholder: "e.g., Full interior + exterior treatment", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_recurring_cost", label: "Option C — Per Visit Cost ($)", type: "text", placeholder: "e.g., 250", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_recurring_includes", label: "Option C — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Full service visit", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_monthly_total", label: "Option C — Monthly Total ($)", type: "text", placeholder: "e.g., 500", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_monthly_includes", label: "Option C — Monthly Includes", type: "bullet-list", placeholder: "e.g., Two visits per month", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_onetime_cost", label: "Option C — One-Time Cost ($)", type: "text", placeholder: "e.g., 800", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_c_onetime_includes", label: "Option C — One-Time Includes", type: "bullet-list", placeholder: "e.g., Complete wildlife exclusion", section: "Service Options", showIf: "ir_option_count:3" },
      { key: "ir_pricing_notes", label: "Pricing Notes", type: "textarea", placeholder: "e.g., Quarterly exterior-only option available at $175/visit", section: "Service Options" },
