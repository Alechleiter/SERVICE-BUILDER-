...
export const TEMPLATES: Record<TemplateId, TemplateDefinition> = {
  ...
  inspection_report: {
    ...
    fields: [
      ...
      { key: "ir_service_frequency", label: "Service Frequency", type: "text", placeholder: "e.g., 2x per month", section: "Scope of Work" },
      { key: "ir_service_areas", label: "Treatment / Service Areas", type: "text", placeholder: "e.g., Exterior and interior", section: "Scope of Work" },
      { key: "ir_phase1_title", label: "Phase 1 Title", type: "text", placeholder: "Initial Service", section: "Scope of Work" },
      { key: "ir_phase1_duration", label: "Phase 1 Duration", type: "text", placeholder: "e.g., Month 1", section: "Scope of Work" },
      { key: "ir_phase1_items", label: "Phase 1 Work Items", type: "bullet-list", placeholder: "e.g., Intensive trapping program: 2 visits per week for 5 weeks", section: "Scope of Work" },
      { key: "ir_phase2_title", label: "Phase 2 Title", type: "text", placeholder: "Ongoing Service", section: "Scope of Work" },
      { key: "ir_phase2_duration", label: "Phase 2 Duration", type: "text", placeholder: "e.g., Monthly", section: "Scope of Work" },
      { key: "ir_phase2_items", label: "Phase 2 Work Items", type: "bullet-list", placeholder: "e.g., Check and service all interior and exterior traps (2x per month)", section: "Scope of Work" },
      ...
      { key: "ir_option_count", label: "Number of Pricing Options", type: "select", options: ["1", "2", "3"], section: "Pricing" },
      // Option A (always visible)
      { key: "ir_option_a_name", label: "Option A — Name", type: "text", placeholder: "e.g., Monthly General Pest", section: "Pricing" },
      { key: "ir_initial_cost", label: "Option A — Initial Service Cost ($)", type: "text", placeholder: "e.g., 2500", section: "Pricing" },
      { key: "ir_initial_includes", label: "Option A — Initial Includes", type: "bullet-list", placeholder: "e.g., Trapping program setup", section: "Pricing" },
      { key: "ir_recurring_cost", label: "Option A — Per Visit Cost ($)", type: "text", placeholder: "e.g., 175", section: "Pricing" },
      { key: "ir_recurring_includes", label: "Option A — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Scheduled service visit", section: "Pricing" },
      { key: "ir_monthly_total", label: "Option A — Monthly Total ($)", type: "text", placeholder: "e.g., 350", section: "Pricing" },
      { key: "ir_monthly_includes", label: "Option A — Monthly Includes", type: "bullet-list", placeholder: "e.g., Two visits per month", section: "Pricing" },
      { key: "ir_onetime_cost", label: "Option A — One-Time Cost ($)", type: "text", placeholder: "e.g., 450", section: "Pricing" },
      { key: "ir_onetime_includes", label: "Option A — One-Time Includes", type: "bullet-list", placeholder: "e.g., One-time exclusion work", section: "Pricing" },
      // Option B (visible when option_count >= 2)
      { key: "ir_b_name", label: "Option B — Name", type: "text", placeholder: "e.g., Quarterly Exterior Only", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_initial_cost", label: "Option B — Initial Cost ($)", type: "text", placeholder: "e.g., 1200", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_initial_includes", label: "Option B — Initial Includes", type: "bullet-list", placeholder: "e.g., Perimeter treatment", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_recurring_cost", label: "Option B — Per Visit Cost ($)", type: "text", placeholder: "e.g., 125", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_recurring_includes", label: "Option B — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Exterior perimeter spray", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_monthly_total", label: "Option B — Monthly Total ($)", type: "text", placeholder: "e.g., 125", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_monthly_includes", label: "Option B — Monthly Includes", type: "bullet-list", placeholder: "e.g., One visit per quarter", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_onetime_cost", label: "Option B — One-Time Cost ($)", type: "text", placeholder: "e.g., 300", section: "Pricing", showIf: "ir_option_count:2,3" },
      { key: "ir_b_onetime_includes", label: "Option B — One-Time Includes", type: "bullet-list", placeholder: "e.g., One-time seal-up", section: "Pricing", showIf: "ir_option_count:2,3" },
      // Option C (visible when option_count == 3)
      { key: "ir_c_name", label: "Option C — Name", type: "text", placeholder: "e.g., Premium Full-Service", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_initial_cost", label: "Option C — Initial Cost ($)", type: "text", placeholder: "e.g., 3500", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_initial_includes", label: "Option C — Initial Includes", type: "bullet-list", placeholder: "e.g., Full interior + exterior treatment", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_recurring_cost", label: "Option C — Per Visit Cost ($)", type: "text", placeholder: "e.g., 250", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_recurring_includes", label: "Option C — Per Visit Includes", type: "bullet-list", placeholder: "e.g., Full service visit", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_monthly_total", label: "Option C — Monthly Total ($)", type: "text", placeholder: "e.g., 500", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_monthly_includes", label: "Option C — Monthly Includes", type: "bullet-list", placeholder: "e.g., Two visits per month", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_onetime_cost", label: "Option C — One-Time Cost ($)", type: "text", placeholder: "e.g., 800", section: "Pricing", showIf: "ir_option_count:3" },
      { key: "ir_c_onetime_includes", label: "Option C — One-Time Includes", type: "bullet-list", placeholder: "e.g., Complete wildlife exclusion", section: "Pricing", showIf: "ir_option_count:3" },
